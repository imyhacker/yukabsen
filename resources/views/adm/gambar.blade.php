...
@section('content')
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Upload Document</h1>
          </div>
            ...
            <div class="col-xl-12 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  ...
                  <font class="text-danger">Jika Error Maka Tidak Terjadi Apa Apa</font>
                </div>
                <!-- Card Body -->
                <div class="card-body">
...
<!--             <div class="form-group">
    ...
    <input type="file" class="custom-file-input" type="file" name="FileUpload" id="validatedCustomFile" name="FileUpload" accept="image/*" required>
    <label class="custom-file-label" for="validatedCustomFile" >Choose file...</label>

          <button type="submit" class="mt-3 btn btn-primary btn-lg btn-block btn-sm">Save!</button>
      </form>
</div>
